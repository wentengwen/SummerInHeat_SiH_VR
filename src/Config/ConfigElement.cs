...
namespace UnityVRMod.Config
{
    public class ConfigElement<T> : IConfigElement
    {
        ...
        public ConfigHandler Handler => IsInternal ? ConfigManager.InternalHandler : ConfigManager.Handler;
        ...
        public void RevertToDefaultValue()
        {
            ...
            {
                VRModCore.LogError($"Failed to revert config '{Name}' to default. Invalid cast? Error: {ex.Message}");
            }
        }
    }
}